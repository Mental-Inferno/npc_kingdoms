...
mobs:register_mob("mobs_mc:rock_crawler", {
	description = S("Rock Crawler"),
	type = "monster",
	spawn_class = "hostile",
	passive = false,
	group_attack = true,
	...
	visual = "mesh",
	mesh = "mobs_mc_crawler.b3d",
	textures = {
		{"mobs_mc_rock_crawler.png"},
	},
	pathfinding = 1,
	visual_size = {x=3, y=3},
	sounds = {
		random = "mobs_mc_crawler_idle",
		death = "mobs_mc_crawler_death",
		damage = "mobs_mc_crawler_hurt",
		distance = 16,
	},
	...
	jump = true,
	fear_height = 4,
	replace_what = mobs_mc.replace.rock_crawler,
	replace_rate = 2,
	animation = {
...
mobs:register_egg("mobs_mc:rock_crawler", S("rock_crawler"), "mobs_mc_spawn_icon_rock_crawler.png", 0)

-- Monster egg blocks (Minetest Game)
if minetest.get_modpath("default") and mobs_mc.create_monster_egg_nodes then
	local spawn_rock_crawler = function(pos, oldnode, oldmetadata, digger)
		if not minetest.is_creative_enabled(digger:get_player_name()) then
			minetest.add_entity(pos, "mobs_mc:rock_crawler")
		end
	end
	minetest.register_node("mobs_mc:monster_egg_stone", {
		description = "Stone Monster Egg",
		tiles = {"default_stone.png"},
		groups = {oddly_breakable_by_hand = 2, spawns_rock_crawler = 1},
		drop = "",
		is_ground_content = true,
		sounds = default.node_sound_stone_defaults(),
		after_dig_node = spawn_rock_crawler,
	})
